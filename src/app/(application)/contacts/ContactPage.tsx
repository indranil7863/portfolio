...
function ContactPage() {
  ...
  return (
    <>
      <h1 className="min-w-[20%] lg:w-[30%] text-center mx-auto lg:text-4xl text-3xl tracking-wide relative font-bold py-4 pr-2 bg-linear-to-r from-blue-500 to-purple-600 bg-clip-text text-transparent">
