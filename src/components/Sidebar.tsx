...
function Sidebar({
  ...
  return (
    <>
      <button className="text-white text-start  px-1" onClick={CancleHandler}>
        <ClearIcon />
      </button>
      ...
      <div className=" bg-gray-200 text-black flex flex-row justify-center items-center gap-2 py-2 rounded-xl">
